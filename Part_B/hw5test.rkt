...
(define tests
  (test-suite
   ...
   (check-equal? (racketlist->mupllist (list (int 3) (list (int 4)))) (apair (int 3) (apair (apair (int 4) (aunit)) (aunit))) "racketlist->mupllist single-nested-list") 
   
   ;; check mupllist to racketlist with normal list
    (check-equal? (mupllist->racketlist (apair (int 3) (apair (int 4) (aunit)))) (list (int 3) (int 4)) "racketlist->mupllist test")
    (check-equal? (mupllist->racketlist (apair (int 3) (apair (apair (int 4) (aunit)) (aunit)))) (list (int 3) (list (int 4))) "racketlist->mupllist single-nested-list")
